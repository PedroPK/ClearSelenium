...
public class IncomeStatementResultsIndicators {
	...
	public static String geNetIncomeLast12Months() {
	...
	public static String geEbitLast12Months() {
	...
	public static String geNetProfitLast12Months() {
	...
	public static String geNetIncomeLast03Months() {
	...
	public static String geEbitLast03Months() {
	...
	public static String geNetProfitLast03Months() {
