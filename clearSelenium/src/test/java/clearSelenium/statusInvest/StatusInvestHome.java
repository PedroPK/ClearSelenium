package clearSelenium.statusInvest;
...
public class StatusInvestHome {
	
	/**
	 * URL's
	 */
	private static final String URL_STATUS_INVEST					=	"https://statusinvest.com.br/";
	private static final String URL_DETALHES_ACAO				=	"https://statusinvest.com.br/acoes/";
	private static final String URL_DETALHES_FII				=	"https://statusinvest.com.br/fundos-imobiliarios/";
	private static final String URL_DETALHES_INDICE				=	"https://statusinvest.com.br/indices/";
	...
	public static void accessStatusInvestHome(boolean pHeadless) {
		//FundamentusHome fundamentusHome = new FundamentusHome();
		accessURL(URL_STATUS_INVEST, pHeadless);
	}
	...
	public static void accessTickerDetails(String pTickerLabel) {
		//FundamentusHome fundamentusHome = new FundamentusHome();
		accessURL(URL_DETALHES_ACAO + pTickerLabel);
	}
	...
	public static void accessTickerDetails(String pTickerLabel, boolean pUseHeadlessWebDriver) {
		//FundamentusHome fundamentusHome = new FundamentusHome();
		accessURL(URL_DETALHES_ACAO + pTickerLabel, pUseHeadlessWebDriver);
	}
	...
	public StatusInvestHome accessFundamentosHomeAndPressExibirButton() {
		return accessFundamentosHomeAndPressExibirButton(false);
	}
	
	public StatusInvestHome pressExibirButton() {
	...
	public StatusInvestHome accessFundamentosHomeAndPressExibirButton(boolean pHeadless) {
		accessStatusInvestHome(pHeadless);
